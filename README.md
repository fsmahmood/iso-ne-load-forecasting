...
📊 **A quick side-by-side model comparison appears in [`02_modeling.ipynb`](notebooks/02_modeling.ipynb) — including naive, seasonal-naive, Holt-Winters, and the Ridge model.**
